...
ggplot(data,aes(x=length, y=number,fill="#93DAD1", colour="#7290CC"))+
  geom_bar(stat ="identity",fill="#93DAD1",colour="#7290CC")+
  theme_minimal()+
...
ggplot(data, aes(x=Chr,y=indel,colour="#9870CB"))+
...
ggplot(data, aes(x=Chr,y=snp,colour="#7290CC"))+
...
m_col = c("#EEBB47","#D8793F","#EA5D2D","#C63581","#349839",
