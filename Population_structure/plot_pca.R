...
m_colour = c("ANG"="#6BB93F","HOL"="#6BB93F","SIM"="#6BB93F","SHO"="#6BB93F","CHR"="#6BB93F","HAW"="#873186","KAZ"="#873186",
             "MON"="#873181","YB"="#873181","MIS"="#18A2CA","KUC"="#18A2CA","WAG"="#E20593","WL"="#DBB71D","BRA"="#b35107")
m_shape = c("ANG"=21,"HOL"=21,"SIM"=21,"SHO"=21,"CHR"=21,"HAW"=21,"KAZ"=21,
            "MON"=21,"YB"=21,"MIS"=25,"KUC"=24,"WAG"=22,"WL"=23,"BRA"=23)
